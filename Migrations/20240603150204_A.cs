        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Preco_pago = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TCompras", x => x.IdCompra);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data_hora_inicio = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Estado_conversa = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TConversas", x => x.IdConversa);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TFavoritos", x => x.IdFavorito);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data_hora_envio = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TMensagens", x => x.IdMensagem);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado_produto = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TProdutos", x => x.IdProduto);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Num_telefone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Data_registo = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Estado_conta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Tipo_conta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Token_verificacao = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TUtilizadores", x => x.IdUtilizador);
                });
